...
import { Search, Package, Tag, Grid3X3, ArrowRight, SlidersHorizontal, ChevronRight, Sparkles, TrendingUp } from "lucide-react";
...
function SearchPageContent() {
  ...
  const fetchSearchResults = useCallback(async (pageNum: number = 1, append: boolean = false) => {
    if (pageNum === 1) {
      setLoading(true);
    } else {
      setLoadingMore(true);
    ...
    try {
      ...
      if (append) {
        ...
        // Only set brands/categories on first page
  ...
  return (
    <div className="min-h-screen bg-[#fafbfc]">
      {/* Hero Header - Matching site's dark header style */}
      <div className="bg-gradient-to-r from-[#0f1720] via-[#162030] to-[#0f1720] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 relative">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            ...
            {/* Stats Cards */}
            {!loading && (filteredProducts.length > 0 || brands.length > 0 || categories.length > 0) && (
      ...
      {/* Mobile Filter (floating button + overlay) - always active */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {loading ? (
          ...
          <div className="flex gap-8">
            {/* Filter Panel - Desktop: Premium Sticky Sidebar */}
            <aside className="hidden lg:block w-[280px] flex-shrink-0">
              <div className="sticky top-24">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                  ...
                  {/* Filter Content */}
                  <div className="p-5 max-h-[calc(100vh-220px)] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-transparent hover:scrollbar-thumb-gray-300">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          ...
                          {hasMore && (
                            <span className="text-emerald-600 font-medium"> · Scroll for more</span>
                          )}
                        </p>
                      </div>
                    </div>
                        ...
                        <div className="relative flex flex-col items-center text-center gap-3">
                          {b.logoUrl ? (
                            <div className="w-16 h-16 relative flex items-center justify-center 
                                          bg-gray-50 rounded-xl p-2 group-hover:bg-white group-hover:shadow-md
                            ...
                            <div className="w-16 h-16 bg-gradient-to-br from-gray-100 to-gray-50 
                          ...
                          <div>
                            ...
                            <div className="flex items-center justify-center gap-1 mt-1.5 text-xs 
                    ...
                    {categories.map((c) => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-center w-6 h-6 rounded-full bg-gray-100 group-hover:bg-emerald-100 transition-colors">
                          <ArrowRight className="w-3.5 h-3.5 text-gray-400 group-hover:text-emerald-600 
                ...
                categories.length === 0 && (
                  <div className="flex flex-col items-center justify-center py-20 px-6">
                    ...
                    <div className="relative mb-8">
                      ...
                      <div className="relative w-32 h-32 bg-gradient-to-br from-gray-100 to-white 
                                    rounded-3xl flex items-center justify-center shadow-xl border border-gray-100">
                    ...
                    <p className="text-gray-500 text-center max-w-md mb-8 leading-relaxed">
                      We couldn&apos;t find anything matching <span className="font-semibold text-gray-700">&quot;{q}&quot;</span>. 
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      <Link 
                        ...
                        className="group inline-flex items-center justify-center gap-2 px-6 py-3.5 
                                 ...
                                 hover:from-[#162030] hover:to-[#243444] shadow-lg shadow-gray-900/20
                                 transition-all duration-300"
                      >
      ...
      <div className="min-h-screen bg-[#fafbfc]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col items-center justify-center py-24">
            ...
            <p className="mt-8 text-gray-500 font-medium animate-pulse">Loading search results...</p>
          </div>
        </div>
      </div>
    }>
